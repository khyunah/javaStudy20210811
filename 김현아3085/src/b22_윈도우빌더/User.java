...
public class User extends JFrame {
	...
	public User() {
		...
		lblNewLabel_6.setFont(new Font("굴림", Font.BOLD, 17));
		lblNewLabel_6.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_6.setBounds(299, 55, 126, 32);
		...
		lblNewLabel_7.setBounds(393, 157, 116, 15);
		...
		update_btn.setBounds(568, 229, 97, 23);
		...
		update_pwd_btn.setBounds(508, 479, 116, 38);
